...
Telegram viene notificato esclusivamente quando almeno un volo ha `availability > 0`. Le opzioni senza posti possono apparire nel log/UI, ma non generano notifiche.
